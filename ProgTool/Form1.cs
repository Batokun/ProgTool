...
namespace ProgTool
{
    public partial class Form1 : Form
    {
        ...
        public void UploadSendMail()
        {
            using (MailMessage mail = new MailMessage())
            {
                mail.From = new MailAddress("progsystemmail@gmail.com");
                mail.To.Add("baterdene.b@icraft.jp");
                mail.Subject = "test message";
                mail.Body = "<h1> please check your csv file </h1>" + DateTime.Now;
        ...
        public void SendMail()
        {
            using (MailMessage mail = new MailMessage())
            {
                ...
                mail.To.Add("baterdene.b@icraft.jp");
                mail.Subject = "test message";
                mail.Body = "<h1> failure on create pdf file </h1>" + DateTime.Now;
                mail.IsBodyHtml = true;
